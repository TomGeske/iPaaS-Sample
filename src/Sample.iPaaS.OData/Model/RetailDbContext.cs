...
namespace Sample.iPaaS.OData.Model
{
    public class RetailDbContext : DbContext
    {
        ...
        public DbSet<OverwriteBusinessLogic> OverwriteBusinessLogicList { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OverwriteBusinessLogic>().ToView("OverwriteBusinessLogic", "BankHoliday_V100").HasNoKey();
